...
\begin{tikzpicture}[scale=1.1, >=Stealth]
  ...
  % Cartesian grid.
  \draw[step=1, very thin, gridcol] (-0.5,-0.5) grid (5.5,4.5);
  ...
  \fill[red!85!white] (A) circle (2pt);
  \fill[red!85!white] (B) circle (2pt);
  \node[below left, text=axiscol] at (0,0) {$O$};
  \node[above right, text=red!85!white] at (A) {$A$};
  \node[below left, text=red!85!white] at (B) {$B$};
